...
const scrollToT = () => {
	...
	const contato = menu.firstElementChild;
	const sobre = menu.lastElementChild;
...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"large", num:400, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:.5, color:"#DECFE2", fill:false}, 
								{id:"medium", num:200, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.3, areaHeight:1, color:"#BD94D1", fill:true}, 
								{id:"large", num:30, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.2, areaHeight:1, color:"#8A49B6", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth:400, ellipseHeight:100, alpha:0.6, offsetX:0, offsetY:0, color:"#FEE8E3"}, 
						{ellipseWidth:350, ellipseHeight:250, alpha:0.3, offsetX:-50, offsetY:0, color:"#FFC9BE"}, 
						{ellipseWidth:100, ellipseHeight:80, alpha:0.2, offsetX:80, offsetY:-50, color:"#FF7F66"}];
...
var particles
(function(){
	particles = new ParticleEngine('bg-canvas');
